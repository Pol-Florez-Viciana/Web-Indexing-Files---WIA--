...
<!-- Nuevo Raiz Secundaria -->
    ...
    <title>Raiz Aplicaciones - Ejemplo Web WIA</title>  
...
if (!isset($_COOKIE["Acepto"])){
	...
	echo '<form id="Formulario1" name="Formulario1" method="POST" action="aplicaciones.php" ><br>'; 
...
<center>
	...
	<!-- Titulo de la Web -->
	<h1 class="WebTitle"> Ejemplo Web WIA Raiz Aplicaciones</h1>
