...
<!-- Nuevo Raiz Secundaria -->
    ...
    <title>Raiz Secundaria - Ejemplo Web WIA</title>  
...
if (!isset($_COOKIE["Acepto"])){
	...
	echo '<form id="Formulario1" name="Formulario1" method="POST" action="raiz-secundaria.php" ><br>'; 
...
<center id="Inicio">
	...
	<!-- Titulo de la Web -->
	<h1 class="WebTitle"> Ejemplo Web WIA Raiz Secundaria</h1>
