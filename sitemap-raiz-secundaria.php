...
<!-- Nuevo Interfaz Creada por Pol Flórez Viciana -->
    ...
    <meta name="description" content="Mapa del Sitio de Raiz Secundaria">
    <meta name="keywords" content="Pol Flórez, Trabajo de Pol Flórez, Pol Software">
    <title>Ejemplo Web WIA Raiz Secundaria - Mapa del Sitio</title>  
...
<center id="Inicio" >
	...
	<h1 class="WebTitle">Raiz Secundaria - Mapa del Sitio</h1>
	
	<section class="WebSection" >
		<hr>
		<h2 class="TitleSection">Menú de la Raiz Xavi Florez</h2>
		<hr>
		<div>
			<?php
				$Dir = "./Menu-Superior/";
				$MiNav = GetDataSiteMap($Dir,false,"raiz-secundaria.php");
				echo($MiNav);
			?>
		</div>
		<hr>
	...
	<section class="WebSection" >
		<hr>
		<h2 class="TitleSection">Todos los Datos de Raiz Xavi Flórez</h2>
		<hr>
		<div>
			<?php
				$Dir = "./Raiz-Secundaria/";
				$MiNav = GetDataSiteMap($Dir,true,"raiz-secundaria.php");
				echo($MiNav);
			?>
		</div>
		<hr>
